...
export function listRoleOptions(
  ...
  return request({
    url: '/kindergarten/roles/options',
    method: 'get',
    params: queryParams
  });
}
...
export function getRoleMenuIds(roleId: number): AxiosPromise<number[]> {
  return request({
    url: '/kindergarten/roles/' + roleId + '/menuIds',
    method: 'get'
  });
}
...
export function updateRoleMenus(
  ...
  return request({
    url: '/kindergarten/roles/' + roleId + '/menus',
    method: 'put',
    data: data
  });
}
...
export function getRoleForm(id: number): AxiosPromise<RoleForm> {
  return request({
    url: '/kindergarten/roles/' + id + '/form',
    method: 'get'
  });
}
