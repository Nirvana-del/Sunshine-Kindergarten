  ...
  <div class="component-container">
    <div class="component-container__main">
      ...
      <el-card class="box-card">
        ...
        <!--          &lt;!&ndash; :span-method="(objectSpanMethod as any)"&ndash;&gt;-->
...
// API 引用
// import {listAttributes} from '@/api/handicrafts/attribute';
import {addDishesApi, updateDishesApi} from '@/api/dishes';
...
const submitForm = () => {
  ...
  // console.log(goodsStock.value)
  let submitsData = Object.assign({}, goodsInfo.value);
  const goodsId = goodsInfo.value.id;
  if (goodsId) {
    // 编辑商品提交
    updateDishesApi(submitsData).then(() => {
    ...
    // 新增商品提交
    addDishesApi(submitsData).then(() => {
      router.push({path: '/dishes/myList'});
      ElNotification({
        title: '提示',
        message: '新增商品成功',
        type: 'success',
...
//           if (goodsId) {
//             // 编辑商品提交
//             updateDishesApi(goodsId, submitsData).then(() => {
